...
function create($data)
{
    ...
    $sql = "INSERT INTO properti_jual (id_jual, id_kategori, id_user, judul, no_telepon, harga, lokasi, kamar_tidur, kamar_mandi, gambar, deskripsi)
                VALUES ('', '$kategori', '$id', '$judul', '$telepon', '$harga', '$lokasi', '$kamar_tidur', '$kamar_mandi', '$gambar', '$deskripsi')";
