        ...
        <nav class="navbar navbar-expand-lg p-1"
            ...
            <div class="container-fluid d-flex justify-content-between">
                ...
                <div class="d-flex gap-2 right-0">
                    ...
                    <a href="login&register/logout.php" class="logout-c rounded-3 mt-2 btn btn-login" id="logOutBtn">
                    ...
                    <?php else : ?>
                    <a class="btn btn-login" href="login&register/login.php" style="width:100px;" id="login">
                        Login
                    </a>
                    <a class="btn btn-login" href="login&register/register.php" style="width: 100px" id="register">
                        Register
                    </a>
                    <?php endif; ?>
                </div>
        ...
        <?php endif ?>
            <?php foreach ($products as $product): ?>
                ...
                <div class="card p-1 shadow-sm border border-none" id="isi-kartu" style="width: 18rem; min-width: 18rem;">
                    <img src="uploadan/<?= $product["gambar"] ?>" class="card-img-top"
                ...
                <div class="leads-text d-flex flex-column gap-3 justify-content-center">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        ...
                        <a href="<?php if(!isset($_SESSION["login"])) {
                            ...
                            echo "userLeads/leadsPage.php?id_user=$idUser";
