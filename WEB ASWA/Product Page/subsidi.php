...
$properties = query("SELECT * FROM properti_jual WHERE id_kategori = 111");
$property = query("SELECT * FROM properti WHERE id_kategori = 111");
?>
...
<body style="font-family: 'Kanit', sans-serif;">
    <header class="bg-navbar1">
        <div class="d-flex justify-content-between align-items-center" style="text-align: center;">
            ...
            <h2 class="fw-bold">Lihat Produk Subsidi</h2>
            <div></div>
        </div>
    </header>
