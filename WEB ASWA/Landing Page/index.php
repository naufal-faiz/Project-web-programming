...
<body style="background-color: #F8F7F4; font-family: 'Kanit';">
                ...
                <div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-3">
                            <li class="nav-item">
                                <a class="nav-link text-white nav-hover" aria-current="page" href="#">Subsidi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white nav-hover" href="#">Cluster</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white nav-hover" href="#">Take Over</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white nav-hover" href="#">Haji & Umroh</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <main>
        <!-- CAROUSEL START -->
        <div class="container">
            <div id="carouselExampleIndicators" class="carousel slide mx-5 my-5 shadow rounded-5"
                ...
                <div class="carousel-inner rounded-5">
                    ...
                    <div class="carousel-item">
                        <img src="../img/uploadan/Gambar5.png" class="d-block w-100" alt="Aswa Carousel" height="500"
                            width="600">
                    </div>
                </div>
        ...
        <div class="d-flex gap-3 text-center overflow-x-auto justify-content-center">
            <?php foreach ($products as $product): ?>
                ...
                <div class="card p-1 shadow-sm border border-none" style="width: 18rem; min-width: 18rem;">
            ...
            <div class="card p-1 shadow-sm" style="width: 18rem; min-width: 18rem">
                <img src="../img/uploadan/Gambar5.png" class="card-img-top" style="height: 10rem; border: 1px solid #776B5D"
                    alt="...">
                <div class="card-body">
                    <h5 class="card-title text-coklat fw-bold">Paket Umroh + Turki</h5>
                    <p class="card-text m-0 fw-medium text-krem">Rp. 25,900,000</p>
                    <p class="card-text m-0">Jl. Perumahan Metland Menteng, Cakung</p>
                </div>
                <div class="mb-3">
                    <a href="../Haji & Umroh Page/haji1.html" class="btn btn-khusus">Lihat Disini</a>
                </div>
            </div>
        </div>
        <!-- CARD END -->
        ...
        <div class="container d-flex justify-content-center mt-5">
            <div class="leads-container shadow-sm w-100 mx-5 d-flex flex-row p-3 flex-wrap bg-white rounded-3 gap-3">
                ...
                <div class="leads-text d-flex flex-column gap-3 justify-content-center>
                    ...
                    <a href="createLeads.php" class="btn btn-khusus" style="width: 180px;">Pasang iklan disini!</a>
                </div>
