...
$properties = query("SELECT * FROM properti_jual WHERE id_jual = '$id' AND id_user = '$idUser'");
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-center gap-1 mt-4">
                <div style="width: 100%; z-index: 19;" class="rounded-2 border-khusus">
                    <img src="../uploadan/<?= $properti["gambar"] ?>" class="w-100 rounded-2" height="700"
                        alt="<?= $properti["gambar"] ?>">
                </div>
            </div>
            ...
            <div class="container-fluid position-sticky" style="background-color: #F8F7F4; bottom: 0; padding: 1px;">
                <div class="d-flex gap-3">
                    <a href="editLeads.php?id_jual=<?= $properti["id_jual"] ?>&id_user=<?= $properti["id_user"] ?>"
