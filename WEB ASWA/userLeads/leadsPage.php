...
$leads = query("SELECT * FROM properti_jual WHERE id_user = '$idUser'");
?>
                ...
                <div class="px-5 mt-3">
                    <div class="card p-3 rounded-4 d-flex flex-row gap-5 flex-wrap">
                        ...
                        <div style="width: 40%;">
                            ...
                            <div class=" d-flex gap-3">
                                <a href="detailLeadsPage.php?id_jual=<?= $lead["id_jual"] ?>&id_user=<?= $idUser ?>"
                                    class="btn btn-khusus px-4 py-1 rounded-3" style="font-size: 23px;">Lihat</a>
                                <a href="editLeads.php?id_jual=<?= $lead["id_jual"] ?>&id_user=<?= $idUser ?>"
                                    class="btn btn-khusus px-4 py-1 rounded-3" style="font-size: 23px;">Edit</a>
                                <a href="deleteLeads.php?id_jual=<?= $lead["id_jual"] ?>&id_user=<?= $idUser ?>"
