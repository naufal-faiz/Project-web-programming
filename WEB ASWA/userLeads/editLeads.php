...
if (isset($_POST["submit"])) {
    if (edit($_POST) > 0) {
        ...
        document.location.href = 'leadsPage.php'
        </script>
        ";
    } else {
        echo "
    ...
    <main class="d-flex justify-content-center">
        ...
        <div class="d-flex flex-column gap-2 mt-3">
            ...
            <div class="d-flex gap-3 ms-3">
                ...
                <input type="radio" class="btn-check" name="id_kategori" id="option2" autocomplete="off" value="112">
                <label class="btn btn-login" for="option2">Cluster</label>
                <input type="radio" class="btn-check" name="id_kategori" id="option3" autocomplete="off" value="113">
